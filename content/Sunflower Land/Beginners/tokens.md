...
| Loại Restock | Cost (Gems) | Shop | Items |
|-------------|-------------|------|-------|
| **Market Restock** | 15 | Farmer's Market | Crops, fruits, flowers, greenhouse |
| **Workbench Restock** | 10 | Workbench | All tools |
| **Digging Restock** | 5 | Jafar (Beach) | Sand Shovels, Sand Drills |
| **Full Restock** | 20 | Any shop | Tất cả (crops + tools + digging) |
