...
related_to:
  ...
  - beginners-guide
source:
  - https://wiki.sfl.world/en/beginners/map
  - https://wiki.sfl.world/en/beginners/guide-draft
...
![Mới tạo farm](../Attachments/game-interface-lv1-new-farm.png)
...
![Bản đồ thế giới](../Attachments/game-interface-map-world.png)
...
![Mint & Humanity verification](../Attachments/game-interface-infog-mint-humanity.png)
...
![Faction overview](../Attachments/game-interface-infog-faction_101.png)
...
![Fire Pit cooking](../Attachments/game-interface-home-firepit.png)
![Feed Bumpkin](../Attachments/game-interface-home-feedbumpkin.png)
...
![Betty's Market](../Attachments/game-interface-home-betty_s_market.png)
...
![Unknown Events](../Attachments/game-interface-infog-unknown_event_101.png)

### Gift Giver & Town Hall

**Gift Giver:** Players (Devs/Admins) với Gift/Love Charm icon. Xuất hiện random → interact nhận Gift.

![Gift Giver](../Attachments/game-interface-giftgiver.png)
...
![Billy NPC](../Attachments/game-interface-npc-billy.png)
